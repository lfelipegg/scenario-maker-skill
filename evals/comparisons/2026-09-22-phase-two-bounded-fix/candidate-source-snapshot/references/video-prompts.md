...
Read `routing.md` and `output-contracts.md` first. These task fields do not change a critique/comparison into prompt writing or authorize video generation. Explicit output formatting overrides presentation defaults below.
