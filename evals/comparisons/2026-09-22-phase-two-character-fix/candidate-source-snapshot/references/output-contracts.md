...
Ordinary Danbooru Version uses canonical tags where possible. When canonical tags cannot faithfully express required lettering or a relationship, add only the minimal faithful literal or relational phrase. Keep the fallback visibly noncanonical—such as quoted exact lettering or a natural-language relationship phrase—rather than disguising it as a validated tag.
