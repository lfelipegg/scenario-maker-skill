...
Infer Wild only from an explicit mode selection or unmistakable creative delegation such as “go wild with the concept.” Ordinary vagueness, “improve this,” or a scene that describes wild animals does not activate it. Without a mode or clear delegation, create and expand remain Balanced while adapt and revise remain Preserve. A more specific constraint bounds broad delegation; genuinely incompatible mode instructions follow the existing conflict rule.
...
- “Animate this opening image with native H3 FL2VA” → image-to-video; ask what should change or move if animation intent is unspecified.
