...
5. Follow `output-contracts.md` for final formatting: canonical tags use lower_snake_case where possible, while minimal fidelity-preserving literal/relational phrases remain distinguishable from canonical tags. Respect explicit formatting and canonical-only constraints; do not normalize exact visible lettering.
