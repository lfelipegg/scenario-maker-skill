...
For a full scene, include subject, setting, visible action, composition, lighting, and atmosphere as applicable. Character, clothing, and isolated-asset scopes do not acquire a full scene merely because the output is prose.
