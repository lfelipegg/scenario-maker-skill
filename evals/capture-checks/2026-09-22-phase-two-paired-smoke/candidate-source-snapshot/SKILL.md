...
3. Apply `references/output-contracts.md`. Resolve genuine incompatibilities before writing; otherwise use sensible visual defaults only within the requested scope.
