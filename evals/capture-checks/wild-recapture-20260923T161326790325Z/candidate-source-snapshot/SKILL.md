...
- Producing the artifact requires resolving ambiguity in supplied source content, the requested revision is genuinely unclear, or simultaneous content instructions conflict. Wild may choose a plausible interpretation of an ambiguous new-creation seed; that exception does not resolve source ambiguity or missing required inputs and reference roles.
