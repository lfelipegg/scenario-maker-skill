...
Express supplied relationships explicitly in the final dialect. Listing the related objects as separate tags does not by itself preserve who acts on what, where the action occurs, or which attribute belongs to which subject.
